...
- **Consume:** Clips de audio de palabras griegas de YT-Extractor (para el botón de audio de las tarjetas); (potencial) textos/recortes guardados en Nous
- **Relaciones:** Consume audio de YT-Extractor para el botón de audio; archiva material en Nous
- **Estado:** usable
