...
import type { BuildStats } from './useBuildSession'

/** Fin de sesión de construir: aciertos + XP/racha/nivel + logros (núcleo compartido). */
export function BuildSummary({
  ...
  return (
    <Card title="¡Sesión completada! 🎉">
      {reviewed === 0 ? (
        <p>No hay frases que construir ahora mismo. Vuelve más tarde 👋</p>
      ) : (
        <>
          <p>
            Construidas: <strong>{reviewed}</strong> · Acertadas:{' '}
          ...
          <p className="summary__cheer">
            {recalled / reviewed >= 0.9
              ...
              : recalled / reviewed >= 0.6
                ? '¡Buen trabajo! 💪'
                : 'Sigue así, el orden se afina con la práctica. 🌱'}
          </p>
          <p>
